...
const Feature = () => {
  ...
  return (
    <div className="w-full p-20 mt-16 flex flex-col items-center bg-background rounded-2xl shadow-lg md:p-40 md:mb-24 md:mt-0 dark:bg-muted bg-opacity-80">
      ...
      <div className="mt-6">
        ...
        >
          <span className="text-lg font-semibold">{t("documentationBtn")}</span>
        </Link>
      </div>
    </div>
  );
