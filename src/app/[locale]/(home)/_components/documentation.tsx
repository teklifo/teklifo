...
const Feature = () => {
  ...
  return (
    <div className="relative group">
      <div className="absolute transition-all duration-1000 opacity-70 -inset-px bg-gradient-to-r from-[#44BCFF] to-[#FF44EC] rounded-xl blur-3xl group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200"></div>
