...
const JoinNowComponent = () => {
  ...
  return (
    <div id="price" className="relative">
      ...
      <div className="flex flex-col justify-center items-center text-center h-[50vh] mt-16 mx-auto backdrop-filter px-10 rounded-3xl bg-background/80 backdrop-blur-lg bg-clip-padding p-8 space-y-5">
        ...
        >
          <span className="text-sm font-semibold md:text-lg">{t("join")}</span>
          <ArrowRight />
        </Link>
      </div>
    </div>
